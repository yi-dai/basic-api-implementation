...
public class RsController {
  ...
  public RsController(UserRepository userRepository, RsEventRepository rsEventRepository, VoteRepository voteRepository, RsEventService rsEventService, RsEventService rsEventService1) {
    this.userRepository = userRepository;
    this.rsEventRepository = rsEventRepository;
    this.voteRepository = voteRepository;
    this.rsEventService = rsEventService1;
  }
  ...
  public ResponseEntity addOneRsEventDB(@RequestBody @Valid RsEventDB rsEventDB) throws JsonProcessingException {
    ...
    boolean resultOfAddRsEvent = rsEventService.addRsEvent(rsEventDB);
    if(resultOfAddRsEvent){
